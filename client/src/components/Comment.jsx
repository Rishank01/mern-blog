...
export default function Comment({comment , onLike , onEdit }) {
    ...
    // This state is stored in order to check whether the comment is edited or not
    ...
    <div className='flex p-4 border-b dark:border-gray-600 text-sm'>
      ...
      <div className='flex-1'>
        <div className='flex items-center mb-1'>
            ...
            {/* moment package to show when the comment was created from now */}
        ...
        <div>
          ...
          <div className='flex items-center pt-2 text-xs border-t dark:border-gray-700 max-w-fit gap-2'>
            <button type = 'button' onClick={() => onLike(comment._id)} className={`text-gray-400 hover:text-blue-400 
            ${
            ...
            {/* To display the number of likes */}
