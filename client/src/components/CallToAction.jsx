  ...
  return (
    <div className='flex flex-col sm:flex-row p-3 border border-teal-500 justify-center items-center rounded-tl-3xl rounded-br-3xl text-center'>
      <div className='flex-1 justify-center flex flex-col'>
        ...
        {/* rel in a just to prevent blocking of out page */}
            <a href = 'https://www.100jsprojects.com' target='_blank' rel = 'noopener noreferrer'>100 JavaScript Projects</a> 
        </Button>
      </div>
      <div className='p-7 flex-1'>
        <img src = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ9ZgcIZio0tL1fCqJ5CVr7D1dgKVGzopxB1d9mWoZymw&s' alt = "Javascript image"/>
      </div>
    </div>
  )
}
